...
Lo que se carga siempre tiene que ser pequeño y estable. El detalle, que se necesita de vez en cuando, se guarda aparte y se trae bajo demanda. Un núcleo caliente y corto, más un archivo frío al que se apunta.
...
La arquitectura funciona no porque tenga más ficheros, sino porque **carga menos y mejor**. Concretando:

Se queda caliente solo lo que el asistente **no puede descubrir solo**. Los inventarios que ya están autogenerados en otro sitio se van, porque leerlos es coste sin ganancia.
...
Esa es la razón última de que funcione: mantiene el núcleo pequeño, guarda solo lo que aporta, y no se fía de la buena voluntad para no pudrirse.
